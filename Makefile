LANGUAGE_NAME := tree-sitter-fpp
HOMEPAGE_URL := https://github.com/tree-sitter/tree-sitter-fpp
VERSION := 0.1.0
DESCRIPTION := Fprime from JPL
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/fpp '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/fpp
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/fpp
